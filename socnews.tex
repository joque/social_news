...
\include{socnews_intro}
\include{socnews_socnet}
\include{socnews_formalism}
\include{socnews_application}
\include{socnews_grp_ext}
\include{socnews_glb_headline}
\include{socnews_concl}
